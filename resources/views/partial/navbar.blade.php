<header x-data="{menuToggle: false}" class="sticky top-0 z-99999 flex w-full border-gray-200 bg-white xl:border-b dark:border-gray-800 dark:bg-gray-900">
    <div class="flex grow flex-col items-center justify-between xl:flex-row xl:px-6">
        <div
            ...
            <a href="{{ route(Auth::user()->getDashboard()) }}" class="xl:hidden">
                <img src="{{ asset('front/assets/img/shape/logo.png') }}" width="100" class="dark:hidden" alt="Logo not found">
                <img src="{{ asset('front/assets/img/shape/logo.png') }}" width="100" class="hidden dark:block" alt="Logo not found">
            </a>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }"
                ...
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
                        <img src="{{ asset(Auth::user()->getAvatar()) }}" alt="User" />
                    </span>

                    <span class="text-theme-sm mr-1 block font-medium"> {{ Auth::user()->getFullName() }} </span>
